...
function myFunction(pageCount, pageNum, totalCount, pageSize, num, pageContent){
	$("#"+pageContent).append("<font>一共<font color='#2ECCFA' id='pageCount' size='6'>"+pageCount+"</font>页</font>"); 
	...
	$("#"+pageContent).append("&nbsp;每页<select id='pageBar' onChange=changePageSize("+totalCount+","+pageNum+") ><option value='2'>2</option><option value='3'>3</option><option value='5'>5</option><option value='10'>10</option></select>条数据");
